...
import {clearSingleUser} from "../../state/actions/user";
...
const ProfilePage = props => {
    ...
    const {getSingleUser, changeAvatar, getCurrentUser,clearSingleUser} = bindActionCreators(userActions, useDispatch())
