...
import LocationWithIcon from "../ui/LocationWithIcon";
import PriceWithTime from "../ui/PriceWithTime";
import RentProcess from "../ui/modals/RentProcess";
...
const ItemPage = props => {
    ...
    const {getSingeItem, getRentedOutItems ,deleteItem, clearCurrentItem} = bindActionCreators(itemActions, useDispatch())
